...
async function loadDashboard() {
    try {
        ...
        document.getElementById('activeUsers').textContent = users.length; // Active users logic can be implemented
        ...
        if (user) {
            ...
            form.innerHTML = `
                <div class="form-group">
                    ...
                    <input type="text" id="edit-username" value="${user.user_name}" required>
                </div>
                <div class="form-group">
                    <label for="edit-role">Role:</label>
                    <select id="edit-role" required>
                        <option value="funcionário" ${user.user_role === 'funcionário' ? 'selected' : ''}>Funcionário</option>
                        <option value="gerente" ${user.user_role === 'gerente' ? 'selected' : ''}>Gerente</option>
                        <option value="administrador de segurança" ${user.user_role === 'administrador de segurança' ? 'selected' : ''}>Administrador de Segurança</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            form.onsubmit = async (e) => {
                ...
                const updatedUser = {
                    ...
                    user_password: document.getElementById('edit-password').value || user.user_password
                };
